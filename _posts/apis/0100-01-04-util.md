...
* A generic severe message is written to the logs.
* If the function completeFailure is provided it will be executed with try and the exception as its arguments.
* If the function completeFailure is NOT provided the last exception encountered is thrown again.
