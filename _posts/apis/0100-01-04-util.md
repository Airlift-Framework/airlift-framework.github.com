...
## - Guid (\[length\])
Creates a guid of type string.  The method for creating the guid involves truncating a SHA1 hash of a random uuid created by java.util.UUID class.  The SHA1 hash is truncated to the length specified.  If no length is specified the value of the application configuration parameter 'airlift.truncated.sha1.id.length' is used instead.  If that is not configured it defaults to 10.

    var u = require('util');
    var id = u.guid(12) //id could be c30215c36032
